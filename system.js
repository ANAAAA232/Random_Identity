...
{   
    ...
    '開花 E.G.O::壇香梅','奥歯事務所 フィクサー','W社 3級 整理要員',
    'ピークォド号 1等航海士','南部ディエーチ協会 4課'];
    //ファウスト
    ...
    'N社 中槌','南部センク協会 5課 部長','中指末妹','ロボトミー E.G.O::提灯'];
    //良秀
    var ryosyu =['LCB 囚人','南部セブン協会 6課','黒雲会 若衆',
    'りょ・ミ・パ 厨房長','W社 3級 整理要員','LCCB 係長'];
    //ムルソー
    ...
    'ぽんぽん派 ボス','南部リウ協会 5課',
    'K社 3級 摘出職職員','W社 2級 整理要員','鈎事務所 フィクサー','南部ディエーチ協会 4課'];
    //ヒースクリフ
    ...
    '奥歯ボートセンター フィクサー','南部センク協会 4課 部長'];
    //ウーティス
    var uteirs =['LCB 囚人','剣契 組織員',
    'G社 部長','南部セブン協会 6課 部長',
    '奥歯事務所 フィクサー','南部センク協会 4課','ロボトミー E.G.O.::魔弾'];
    //グレゴール
